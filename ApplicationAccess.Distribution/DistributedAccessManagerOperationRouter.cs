...
{
    /// <summary>
    /// Distributes operations to two sets of shards in a distributed AccessManager implementation, aggregating and returning their results if required.  Designed to sit in front the 'source' and 'target' nodes of a shard split, and provide routing functionality whilst the splitting process occurs.
    /// </summary>
        ...
        where TClientConfiguration : IDistributedAccessManagerAsyncClientConfiguration, IEquatable<TClientConfiguration>
    {
        ...
        /// <summary>Used to pause and resume incoming operation requests.</summary>
        protected IThreadPauser threadPauser;
        /// <summary>Whether the IThreadPauser member was instantiated within the class constructor.</summary>
        protected Boolean threadPauserInstantiatedInConstructor;
        ...
        (
            ...
            new DefaultThreadPauser(),
            routingOn,
            metricLogger
        )
        {
            threadPauserInstantiatedInConstructor = true;
        }
        ...
        /// <param name="userHashCodeGenerator">A hash code generator for users.</param>
        /// <param name="groupHashCodeGenerator">A hash code generator for groups.</param>
        /// <param name="threadPauser">Used to pause and resume incoming operation requests.</param>
        /// <param name="routingOn">Whether or not the routing functionality is initially swicthed on.  If false (off) all operations are routed to the source shard.</param>
        /// <param name="metricLogger">Logger for metrics.</param>
            ...
            : base(shardClientManager, metricLogger)
        {
            ...
            this.threadPauser = new DefaultThreadPauser();
            this.threadPauser = threadPauser;
            threadPauserInstantiatedInConstructor = false;
        ...
        protected void InitializeMethodNameToSupportedDataTypeMap()
        {
            ...
            {
                { nameof(this.GetUsersAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.GetGroupsAsync), new HashSet<DataElement>() { DataElement.User, DataElement.Group } },
                { nameof(this.GetEntityTypesAsync), new HashSet<DataElement>() { DataElement.User, DataElement.Group } },
                { nameof(this.AddUserAsync), new HashSet<DataElement>() },
                { nameof(this.ContainsUserAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.RemoveUserAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.AddGroupAsync), new HashSet<DataElement>() },
                { nameof(this.ContainsGroupAsync), new HashSet<DataElement>() { DataElement.User, DataElement.Group } },
                { nameof(this.RemoveGroupAsync), new HashSet<DataElement>() { DataElement.User, DataElement.Group } },
                { nameof(this.AddUserToGroupMappingAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.GetUserToGroupMappingsAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.GetGroupToUserMappingsAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.RemoveUserToGroupMappingAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.AddGroupToGroupMappingAsync), new HashSet<DataElement>() },
                { nameof(this.GetGroupToGroupMappingsAsync), new HashSet<DataElement>() },
                { nameof(this.GetGroupToGroupReverseMappingsAsync), new HashSet<DataElement>() },
                { nameof(this.RemoveGroupToGroupMappingAsync), new HashSet<DataElement>() },
                { nameof(this.AddUserToApplicationComponentAndAccessLevelMappingAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.GetUserToApplicationComponentAndAccessLevelMappingsAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.GetApplicationComponentAndAccessLevelToUserMappingsAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.RemoveUserToApplicationComponentAndAccessLevelMappingAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.AddGroupToApplicationComponentAndAccessLevelMappingAsync), new HashSet<DataElement>() { DataElement.Group } },
                { nameof(this.GetGroupToApplicationComponentAndAccessLevelMappingsAsync), new HashSet<DataElement>() { DataElement.Group } },
                { nameof(this.GetApplicationComponentAndAccessLevelToGroupMappingsAsync), new HashSet<DataElement>() { DataElement.Group } },
                { nameof(this.RemoveGroupToApplicationComponentAndAccessLevelMappingAsync), new HashSet<DataElement>() { DataElement.Group } },
                { nameof(this.AddEntityTypeAsync), new HashSet<DataElement>() { DataElement.User, DataElement.Group } },
                { nameof(this.ContainsEntityTypeAsync), new HashSet<DataElement>() { DataElement.User, DataElement.Group } },
                { nameof(this.RemoveEntityTypeAsync), new HashSet<DataElement>() { DataElement.User, DataElement.Group } },
                { nameof(this.AddEntityAsync), new HashSet<DataElement>() },
                { nameof(this.GetEntitiesAsync), new HashSet<DataElement>() { DataElement.User, DataElement.Group } },
                { nameof(this.ContainsEntityAsync), new HashSet<DataElement>() { DataElement.User, DataElement.Group } },
                { nameof(this.RemoveEntityAsync), new HashSet<DataElement>() { DataElement.User, DataElement.Group } },
                { nameof(this.AddUserToEntityMappingAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.GetUserToEntityMappingsAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.GetEntityToUserMappingsAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.RemoveUserToEntityMappingAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.AddGroupToEntityMappingAsync), new HashSet<DataElement>() { DataElement.Group } },
                { nameof(this.GetGroupToEntityMappingsAsync), new HashSet<DataElement>() { DataElement.Group } },
                { nameof(this.GetEntityToGroupMappingsAsync), new HashSet<DataElement>() { DataElement.Group } },
                { nameof(this.RemoveGroupToEntityMappingAsync), new HashSet<DataElement>() { DataElement.Group } },
                { nameof(this.HasAccessToApplicationComponentAsync), new HashSet<DataElement>() { DataElement.User, DataElement.Group } },
                { nameof(this.HasAccessToEntityAsync), new HashSet<DataElement>() { DataElement.User, DataElement.Group } },
                { nameof(this.GetApplicationComponentsAccessibleByUserAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.GetApplicationComponentsAccessibleByGroupAsync), new HashSet<DataElement>() { DataElement.Group } },
                { nameof(this.GetApplicationComponentsAccessibleByGroupsAsync), new HashSet<DataElement>() { DataElement.Group } },
                { nameof(this.GetEntitiesAccessibleByUserAsync), new HashSet<DataElement>() { DataElement.User } },
                { nameof(this.GetEntitiesAccessibleByGroupAsync), new HashSet<DataElement>() { DataElement.Group } },
                { nameof(this.GetEntitiesAccessibleByGroupsAsync), new HashSet<DataElement>() { DataElement.Group } }
            };
        ...
        /// <summary>
        /// Releases the unmanaged resources used by the DistributedAccessManagerOperationRouter.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
        ...
        ~DistributedAccessManagerOperationRouter()
        {
            Dispose(false);
        }
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!disposed)
            {
                if (disposing)
                {
                    ...
                    if (threadPauserInstantiatedInConstructor == true)
                    {
                        ((IDisposable)threadPauser).Dispose();
                    }
                }
