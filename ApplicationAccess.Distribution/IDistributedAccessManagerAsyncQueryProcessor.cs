...
namespace ApplicationAccess
{
    ...
    public interface IDistributedAccessManagerAsyncQueryProcessor<TUser, TGroup, TComponent, TAccess>
    {
        ...
        /// <remarks>Unlike the <see cref="IAccessManagerAsyncQueryProcessor{TUser, TGroup, TComponent, TAccess}.GetApplicationComponentsAccessibleByGroupAsync(TGroup)">'user' parameter overload of the method</see>, this method does not check access of groups indirectly mapped to the groups specified in the <paramref name="groups"/> parameter.</remarks>
        ...
        /// <remarks>Unlike the <see cref="IAccessManagerAsyncQueryProcessor{TUser, TGroup, TComponent, TAccess}.GetApplicationComponentsAccessibleByGroupAsync(TGroup)">'group' parameter overload of the method</see>, this method does not check access of groups indirectly mapped to the groups specified in the <paramref name="groups"/> parameter.</remarks>
        ...
        /// <remarks>Unlike the <see cref="IAccessManagerAsyncQueryProcessor{TUser, TGroup, TComponent, TAccess}.GetEntitiesAccessibleByGroupAsync(TGroup)">'group' parameter overload of the method</see>, this method does not check access of groups indirectly mapped to the groups specified in the <paramref name="groups"/> parameter.</remarks>
        ...
        /// <remarks>Unlike the <see cref="IAccessManagerAsyncQueryProcessor{TUser, TGroup, TComponent, TAccess}.GetEntitiesAccessibleByGroupAsync(TGroup, String)">'group' parameter overload of the method</see>, this method does not check access of groups indirectly mapped to the groups specified in the <paramref name="groups"/> parameter.</remarks>
