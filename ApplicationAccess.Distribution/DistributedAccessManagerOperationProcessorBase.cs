...
{
    /// <summary>
    /// Base for classes which manage operations across a distributed AccessManager implementation.
    /// </summary>
    /// <typeparam name="TClientConfiguration">The type of AccessManager client configuration used to create clients to connect to the shards in the distributed AccessManager.</typeparam>
    public abstract class DistributedAccessManagerOperationProcessorBase<TClientConfiguration>
        where TClientConfiguration : IDistributedAccessManagerAsyncClientConfiguration, IEquatable<TClientConfiguration>
    {
        ...
        /// <summary>
        /// Initialises a new instance of the ApplicationAccess.Distribution.DistributedAccessManagerOperationProcessorBase class.
        /// </summary>
        ...
        public DistributedAccessManagerOperationProcessorBase(IShardClientManager<TClientConfiguration> shardClientManager, IMetricLogger metricLogger)
        {
