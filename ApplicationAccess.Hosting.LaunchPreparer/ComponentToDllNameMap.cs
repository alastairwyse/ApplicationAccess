...
namespace ApplicationAccess.Hosting.LaunchPreparer
{
    ...
    public static class ComponentToDllNameMap
    {
        ...
        private static Dictionary<AccessManagerComponent, String> underlyingMap = new Dictionary<AccessManagerComponent, String>()
        {
            ...
            { AccessManagerComponent.DistributedOperationCoordinatorNode, "ApplicationAccess.Hosting.Rest.DistributedOperationCoordinator.dll" }, 
            { AccessManagerComponent.DistributedOperationRouterNode, "ApplicationAccess.Hosting.Rest.DistributedOperationRouter.dll" }
        };
