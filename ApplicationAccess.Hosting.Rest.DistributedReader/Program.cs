    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            var parameters = new ApplicationInitializerParameters()
            {
                ...
                SwaggerApplicationName = "ApplicationAccess Distributed Reader Node",
                SwaggerApplicationDescription = "Node in a distributed/scaled and dependency-free deployment of ApplicationAccess which handles query/read operations",
            ...
            WebApplication app = initializer.Initialize<DistributedReaderNodeHostedServiceWrapper>(parameters);
