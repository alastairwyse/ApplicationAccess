...
{
    /// <summary>
    /// Integration tests for query methods in the ApplicationAccess.Hosting.Rest.AsyncClient.AccessManagerAsyncClient class.
    /// </summary>
    public class AccessManagerAsyncClientQueryTests : ReaderIntegrationTestsBase
    {
        ...
        private IAccessManagerAsyncQueryProcessor<String, String, String, String> testAccessManagerAsyncClient;
