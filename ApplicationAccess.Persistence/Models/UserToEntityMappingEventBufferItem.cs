...
namespace ApplicationAccess.Persistence.Models
{
    ...
    public class UserToEntityMappingEventBufferItem<TUser> : EntityEventBufferItem
    {
        ...
        public UserToEntityMappingEventBufferItem(Guid eventId, EventAction eventAction, TUser user, string entityType, string entity, DateTime occurredTime, Int32 hashCode)
