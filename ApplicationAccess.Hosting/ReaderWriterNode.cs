...
namespace ApplicationAccess.Hosting
{
    ...
    public class ReaderWriterNode<TUser, TGroup, TComponent, TAccess> : ReaderWriterNodeBase<TUser, TGroup, TComponent, TAccess, MetricLoggingConcurrentAccessManager<TUser, TGroup, TComponent, TAccess>>
    {
        /// <summary>
