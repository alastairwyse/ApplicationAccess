...
namespace ApplicationAccess.Hosting
{
    ...
    public interface IDistributedOperationCoordinatorNodeShardConfigurationRefreshStrategy
    {
        ...
        /// <summary>
        /// Notifies the strategy that an operation was processed by the <see cref="DistributedOperationCoordinatorNode{TClientConfiguration, TClientConfigurationJsonSerializer}"/>.
        /// </summary>
        /// <exception cref="ReaderNodeRefreshException">An exception occurred whilst attempting to refresh/update the shard configuration.</exception>
        void NotifyOperationProcessed();
    }
}
