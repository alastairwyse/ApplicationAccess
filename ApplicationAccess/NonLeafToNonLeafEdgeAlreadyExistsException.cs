...
namespace ApplicationAccess
{
    ...
    public class NonLeafToNonLeafEdgeAlreadyExistsException<TNonLeaf> : Exception
    {
        /// <summary>The vertex which is the 'from' vertex of the edge which already exists in the graph.</summary>
        protected TNonLeaf fromVertex;
        ...
        public NonLeafToNonLeafEdgeAlreadyExistsException(String message, TNonLeaf fromVertex, TNonLeaf toVertex)
            : base(message)
        {
