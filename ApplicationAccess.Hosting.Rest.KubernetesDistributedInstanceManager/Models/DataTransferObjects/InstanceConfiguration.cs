...
{
    /// <summary>
    /// DTO container class holding Kubernetes distributed AccessManager instance manager instance configuration.
    /// </summary>
    public class InstanceConfiguration
    {
        ...
        public List<KubernetesShardGroupConfiguration> UserShardGroupConfiguration { get; set; }
        public List<KubernetesShardGroupConfiguration> GroupToGroupMappingShardGroupConfiguration { get; set; }
        public List<KubernetesShardGroupConfiguration> GroupShardGroupConfiguration { get; set; }
