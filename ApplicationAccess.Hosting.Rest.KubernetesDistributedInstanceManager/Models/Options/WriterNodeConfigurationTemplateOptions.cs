...
{
    /// <summary>
    /// Model/container class storing options corresponding to class <see cref="WriterNodeConfiguration"/>, and following the <see href="https://learn.microsoft.com/en-us/aspnet/core/fundamentals/configuration/options?view=aspnetcore-6.0">ASP.NET Core Options pattern</see>.
    /// </summary>
    public class WriterNodeConfigurationTemplateOptions
    {
