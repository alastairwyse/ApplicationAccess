...
{
    /// <summary>
    /// Model/container class storing options corresponding to class <see cref="DistributedOperationRouterNodeConfiguration"/>, and following the <see href="https://learn.microsoft.com/en-us/aspnet/core/fundamentals/configuration/options?view=aspnetcore-6.0">ASP.NET Core Options pattern</see>.
    /// </summary>
    public class DistributedOperationRouterNodeConfigurationTemplateOptions
    {
        #pragma warning disable 0649

        public const String DistributedOperationRouterNodeConfigurationTemplateOptionsName = "DistributedOperationRouterNodeConfigurationTemplate";

        protected const String ValidationErrorMessagePrefix = $"Error validating {DistributedOperationRouterNodeConfigurationTemplateOptionsName} options";
