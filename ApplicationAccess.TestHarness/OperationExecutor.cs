...
namespace ApplicationAccess.TestHarness
{
    ...
    public class OperationExecutor<TUser, TGroup, TComponent, TAccess> : TwoWaySignallingParticipantBase
    {
        ...
        /// <summary>Whether to generate primary 'Add' operations/events against the AccessManager under test (e.g. AddUser, AddEntityType, etc...).</summary>
        ...
        public override void Start()
        {
            ...
            var operationExecutor = new OperationExecutionPreparer<TUser, TGroup, TComponent, TAccess>(parameterGenerator, testAccessManagerQueryProcessor, testAccessManagerEventProcessor, dataElementStorer, generatePrimaryAddOperations);
