...
namespace ApplicationAccess.Hosting.Rest.Client
{
    ...
    public class EventCacheClient<TUser, TGroup, TComponent, TAccess> : AccessManagerClientBase<TUser, TGroup, TComponent, TAccess>, IAccessManagerEventCache<TUser, TGroup, TComponent, TAccess>
    {
