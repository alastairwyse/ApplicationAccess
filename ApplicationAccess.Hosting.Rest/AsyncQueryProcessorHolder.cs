...
{
    /// <summary>
    /// Holds an instance of <see cref="IAccessManagerAsyncQueryProcessor{TUser, TGroup, TComponent, TAccess}"/>.
    /// </summary>
    ...
    public class AsyncQueryProcessorHolder
    {
        #pragma warning disable 0649

        public IAccessManagerAsyncQueryProcessor<String, String, String, String> AsyncQueryProcessor { get; set; }
