...
namespace ApplicationAccess.Persistence
{
    ...
    public class EventCacheEmptyException : Exception
    {
        ...
        public EventCacheEmptyException(String message, Exception innerException)
