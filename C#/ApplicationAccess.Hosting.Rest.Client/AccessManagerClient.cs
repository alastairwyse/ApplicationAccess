...
{
    public class AccessManagerClient<TUser, TGroup, TComponent, TAccess> : AccessManagerClientBase<TUser, TGroup, TComponent, TAccess>, IAccessManager<TUser, TGroup, TComponent, TAccess>
    {
