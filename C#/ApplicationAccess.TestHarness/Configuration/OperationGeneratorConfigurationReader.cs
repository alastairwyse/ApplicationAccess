...
{
    class OperationGeneratorConfigurationReader : ConfigurationReaderBase
    {
        ...
        public OperationGeneratorConfiguration Read(IConfigurationSection configurationSection)
        {
            ...
            var storeageCountsReader = new ElementTargetStorageCountsConfigurationReader();
