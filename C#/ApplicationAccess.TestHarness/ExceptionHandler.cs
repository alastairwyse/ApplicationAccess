...
namespace ApplicationAccess.TestHarness
{
    ...
    public class ExceptionHandler
    {
        ...
        public ExceptionHandler(Double exceptionsPerSecondThreshold, Int32 previousExceptionOccurenceTimeWindowSize, IApplicationLogger logger)
        {
        ...
        {
            if (knownAccessManagerExceptions.Contains(inputException.GetType()) == false)
            {
