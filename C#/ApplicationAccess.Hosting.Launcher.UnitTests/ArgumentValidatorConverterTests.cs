...
namespace ApplicationAccess.Hosting.Launcher.UnitTests
{
    ...
    public class ArgumentValidatorConverterTests
    {
        ...
        public void Convert_ComponentArgumentInvalidValue()
        {
            ...
            Assert.That(e.Message, Does.StartWith("Value 'InvalidComponent' is invalid for parameter 'component'.  Valid values are 'EventCacheNode', 'ReaderNode', 'ReaderWriterNode', 'WriterNode'"));
