...
namespace ApplicationAccess
{
    ...
    public interface IDirectedGraphSerializer<TSerializedObject>
    {
        ...
        TSerializedObject Serialize<TLeaf, TNonLeaf>(DirectedGraph<TLeaf, TNonLeaf> graph, IUniqueStringifier<TLeaf> leafStringifier, IUniqueStringifier<TNonLeaf> nonLeafStringifier);
        ...
        DirectedGraph<TLeaf, TNonLeaf> Deserialize<TLeaf, TNonLeaf>(TSerializedObject serializedGraph, IUniqueStringifier<TLeaf> leafStringifier, IUniqueStringifier<TNonLeaf> nonLeafStringifier);
    }
}
