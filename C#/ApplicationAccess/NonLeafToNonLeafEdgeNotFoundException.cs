...
namespace ApplicationAccess
{
    ...
    public class NonLeafToNonLeafEdgeNotFoundException<TNonLeaf> : Exception
    {
        ...
        public NonLeafToNonLeafEdgeNotFoundException(String message, TNonLeaf fromVertex, TNonLeaf toVertex)
            : base(message)
        {
