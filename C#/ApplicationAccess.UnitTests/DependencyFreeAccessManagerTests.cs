...
namespace ApplicationAccess.UnitTests
{
    ...
    public class DependencyFreeAccessManagerTests
    {
        ...
        {
            CreateGroupGraph(testDependencyFreeAccessManager);
            var testGroups = new List<String>() { "Grp1", "Grp5", "Grp8", "Grp11" };

            HashSet<String> result = testDependencyFreeAccessManager.GetGroupToGroupMappings(testGroups);
            ...
            result = testDependencyFreeAccessManager.GetGroupToGroupMappings(testGroups);
        ...
        public void HasAccessToApplicationComponentGroupsOverload_GroupHasAccess()
        {
            ...
            testDependencyFreeAccessManager.AddGroup("group2");
            testDependencyFreeAccessManager.AddGroup("group3");
            testDependencyFreeAccessManager.AddGroupToApplicationComponentAndAccessLevelMapping("group2", ApplicationScreen.ManageProducts, AccessLevel.Delete);

            Boolean result = testDependencyFreeAccessManager.HasAccessToApplicationComponent(new List<String>() { "group1", "group2", "group3" }, ApplicationScreen.ManageProducts, AccessLevel.Delete);
        ...
        public void HasAccessToApplicationComponentGroupsOverload_NoGroupsHaveAccess()
        {
            ...
            testDependencyFreeAccessManager.AddGroup("group2");
            testDependencyFreeAccessManager.AddGroup("group3");
            testDependencyFreeAccessManager.AddGroupToApplicationComponentAndAccessLevelMapping("group1", ApplicationScreen.ManageProducts, AccessLevel.Create);
            testDependencyFreeAccessManager.AddGroupToApplicationComponentAndAccessLevelMapping("group1", ApplicationScreen.ManageProducts, AccessLevel.Delete);
            testDependencyFreeAccessManager.AddGroupToApplicationComponentAndAccessLevelMapping("group2", ApplicationScreen.Order, AccessLevel.Create);
            testDependencyFreeAccessManager.AddGroupToApplicationComponentAndAccessLevelMapping("group3", ApplicationScreen.Summary, AccessLevel.View);

            Boolean result = testDependencyFreeAccessManager.HasAccessToApplicationComponent(new List<String>() { "group1", "group2", "group3" }, ApplicationScreen.ManageProducts, AccessLevel.Modify);
        ...
        public void HasAccessToApplicationComponentGroupsOverload_InvalidGroupIncluded()
        {
            ...
            Boolean result = testDependencyFreeAccessManager.HasAccessToApplicationComponent(new List<String>() { "invalid group", "group2", "group3" }, ApplicationScreen.ManageProducts, AccessLevel.Delete);
        ...
        public void HasAccessToEntityGroupsOverload_GroupHasAccess()
        {
            ...
            testDependencyFreeAccessManager.AddGroup("group2");
            testDependencyFreeAccessManager.AddGroup("group3");
            testDependencyFreeAccessManager.AddEntityType("ClientAccount");
            testDependencyFreeAccessManager.AddEntity("ClientAccount", "CompanyA");
            testDependencyFreeAccessManager.AddEntity("ClientAccount", "CompanyB");
            testDependencyFreeAccessManager.AddGroupToEntityMapping("group1", "ClientAccount", "CompanyA");
            testDependencyFreeAccessManager.AddGroupToEntityMapping("group2", "ClientAccount", "CompanyB");

            Boolean result = testDependencyFreeAccessManager.HasAccessToEntity(new List<String>() { "group1", "group2", "group3" }, "ClientAccount", "CompanyB");
        ...
        public void HasAccessToEntityGroupsOverload_NoGroupsHaveAccess()
        {
            ...
            testDependencyFreeAccessManager.AddEntity("ClientAccount", "CompanyA");
            testDependencyFreeAccessManager.AddEntity("ClientAccount", "CompanyB");
            testDependencyFreeAccessManager.AddEntity("ClientAccount", "CompanyC");
            testDependencyFreeAccessManager.AddGroupToEntityMapping("group1", "ClientAccount", "CompanyA");
            testDependencyFreeAccessManager.AddGroupToEntityMapping("group2", "ClientAccount", "CompanyB");

            Boolean result = testDependencyFreeAccessManager.HasAccessToEntity(new List<String>() { "group1", "group2", "group3" }, "ClientAccount", "CompanyC");
        ...
        public void HasAccessToEntityGroupsOverload_InvalidGroupIncluded()
        {
            ...
            Boolean result = testDependencyFreeAccessManager.HasAccessToEntity(new List<String>() { "invalid group", "group2", "group3" }, "ClientAccount", "CompanyB");
        ...
        public void HasAccessToEntityGroupsOverload_InvalidEntityType()
        {
            ...
            Boolean result = testDependencyFreeAccessManager.HasAccessToEntity(new List<String>() { "group1", "group2", "group3" }, "InvalidEntityType", "CompanyB");
        ...
        public void HasAccessToEntityGroupsOverload_InvalidEntity()
        {
            ...
            Boolean result = testDependencyFreeAccessManager.HasAccessToEntity(new List<String>() { "group1", "group2", "group3" }, "ClientAccount", "InvalidEntity");
        ...
        {
            testDependencyFreeAccessManager.AddGroupToGroupMapping("Grp1", "Grp4");
            testDependencyFreeAccessManager.AddGroupToGroupMapping("Grp1", "Grp5");
            testDependencyFreeAccessManager.AddGroupToGroupMapping("Grp2", "Grp5");
            testDependencyFreeAccessManager.AddGroupToGroupMapping("Grp3", "Grp5");
            testDependencyFreeAccessManager.AddGroupToGroupMapping("Grp3", "Grp6");
            testDependencyFreeAccessManager.AddGroupToGroupMapping("Grp4", "Grp7");
            testDependencyFreeAccessManager.AddGroupToGroupMapping("Grp4", "Grp8");
            testDependencyFreeAccessManager.AddGroupToGroupMapping("Grp5", "Grp8");
            testDependencyFreeAccessManager.AddGroupToGroupMapping("Grp6", "Grp8");
            testDependencyFreeAccessManager.AddGroupToGroupMapping("Grp6", "Grp9");
            testDependencyFreeAccessManager.AddGroupToGroupMapping("Grp10", "Grp3");
            testDependencyFreeAccessManager.AddGroupToGroupMapping("Grp11", "Grp12");
        }
