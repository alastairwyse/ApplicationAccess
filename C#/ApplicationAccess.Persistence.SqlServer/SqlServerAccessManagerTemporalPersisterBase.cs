...
namespace ApplicationAccess.Persistence.SqlServer
{
    ...
    public abstract class SqlServerAccessManagerTemporalPersisterBase<TUser, TGroup, TComponent, TAccess> : IAccessManagerTemporalPersistentReader<TUser, TGroup, TComponent, TAccess>
    {
