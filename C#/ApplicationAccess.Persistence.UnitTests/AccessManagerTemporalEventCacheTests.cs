...
namespace ApplicationAccess.Persistence.UnitTests
{
    ...
    public class AccessManagerTemporalEventCacheTests
    {
        ...
        public void PersistEvents()
        {
            ...
            testAccessManagerTemporalEventCache.PersistEvents(testEvents);

            IList<TemporalEventBufferItemBase> result = testAccessManagerTemporalEventCache.GetAllEventsSince(eventId2);
            Assert.AreEqual(1, result.Count);
