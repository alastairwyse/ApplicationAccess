...
namespace ApplicationAccess.Persistence.UnitTests
{
    ...
    public class SizeLimitedLoopingWorkerThreadHybridBufferFlushStrategyTests
    {
        ...
        /// <summary>
        /// Creates a DateTime from the specified yyyy-MM-dd HH:m:ss.fff format string.
        /// </summary>
        ...
        {
            DateTime returnDateTime = DateTime.ParseExact(stringifiedDateTime, "yyyy-MM-dd HH:m:ss.fff", DateTimeFormatInfo.InvariantInfo);
