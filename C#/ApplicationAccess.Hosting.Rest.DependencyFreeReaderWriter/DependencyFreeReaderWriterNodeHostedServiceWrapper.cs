...
namespace ApplicationAccess.Hosting.Rest.DependencyFreeReaderWriter
{
    ...
    public class DependencyFreeReaderWriterNodeHostedServiceWrapper : IHostedService
    {
        ...
        protected ILogger<DependencyFreeReaderWriterNodeHostedServiceWrapper> logger;

        /// <summary>Flush strategy for the <see cref="IAccessManagerEventBuffer{TUser, TGroup, TComponent, TAccess}"/> instance used by the DependencyFreeReaderWriterNode.</summary>
        ...
        protected DependencyFreeReaderWriterNode<String, String, String, String> readerWriterNode;
        ...
        {
            logger.LogInformation($"Starting {nameof(DependencyFreeReaderWriterNodeHostedServiceWrapper)}...");

            logger.LogInformation($"Constructing DependencyFreeReaderWriterNode instance...");

            // Initialize the DependencyFreeReaderWriterNode constructor parameter members from configuration
            ...
            // Create the DependencyFreeReaderWriterNode
            if (metricLoggingOptions.MetricLoggingEnabled.Value == false)
            {
                readerWriterNode = new DependencyFreeReaderWriterNode<String, String, String, String>(eventBufferFlushStrategy, eventPersister, eventPersister, accessManagerOptions.StoreBidirectionalMappings.Value);
            }
            else
            {
                readerWriterNode = new DependencyFreeReaderWriterNode<String, String, String, String>(eventBufferFlushStrategy, eventPersister, eventPersister, accessManagerOptions.StoreBidirectionalMappings.Value, metricLogger);
            }

            // Set the DependencyFreeReaderWriterNode on the 'holder' classes
            ...
            logger.LogInformation($"Completed constructing DependencyFreeReaderWriterNode instance.");
            ...
            // Load the current state of the DependencyFreeReaderWriterNode from storage
            ...
            logger.LogInformation($"Completed starting {nameof(DependencyFreeReaderWriterNodeHostedServiceWrapper)}.");
        ...
        {
            logger.LogInformation($"Stopping {nameof(DependencyFreeReaderWriterNodeHostedServiceWrapper)}...");
            ...
            logger.LogInformation($"Completed stopping {nameof(DependencyFreeReaderWriterNodeHostedServiceWrapper)}.");
        ...
        {
            String sqlServerMetricLoggerCategoryName = "ApplicationAccessDependencyFreeReaderWriterNode"; 
