...
{
    /// <summary>
    /// Container class storing options for processing the buffer(s) for metrics, and following the <see href="https://learn.microsoft.com/en-us/aspnet/core/fundamentals/configuration/options?view=aspnetcore-6.0">ASP.NET Core Options pattern</see>.
    /// </summary>
    public class MetricBufferProcessingOptions
    {
